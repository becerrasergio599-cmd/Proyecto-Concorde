# Proyecto-Concorde
Nombre del proyecto SMIC
Descripcion: Este proyecto consiste en el desarrollo de la pagina web concorde con el fin de atraer mas clientes mediante la optimizacion de la atención al cliente de mediante la pagina web
